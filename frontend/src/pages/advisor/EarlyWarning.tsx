      ...
      <Modal isOpen={showCreate} onClose={() => setShowCreate(false)} title={t('สร้างเคสเตือนภัยวิชาการใหม่', 'Create Early Warning Case')} size="md">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-semibold text-slate-800 dark:text-slate-200 mb-1">Warning Factor *</label>
              <select
                value={warningType}
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-800 dark:text-slate-200 mb-1">Severity Level *</label>
              <select
                value={severity}
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-800 dark:text-slate-200 mb-1">Observations & Risk Description *</label>
            <textarea
              value={description}
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-800 dark:text-slate-200 mb-1">Recommended Intervention</label>
            <textarea
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-800 dark:text-slate-200 mb-1">Follow-up Target Date</label>
            <input
              type="date"
              value={followUpDate}
