              ...
              {voiceResponse && (
                <div className="border-t border-sky-100 pt-4">
                  ...
                  <div className="space-y-2 p-3.5 bg-sky-50/60 dark:bg-sky-950/40 rounded-xl border border-sky-100 dark:border-sky-900/40 text-xs">
                    <div className="flex flex-wrap items-center gap-3 text-[11px] font-semibold text-slate-700 dark:text-slate-300 border-b border-sky-100/80 pb-2">
                      <span>{t('คะแนนหลักสูตร:', 'Curriculum:')} <strong className="text-sky-700">{voiceResponse.ratings.curriculumRelevance}/5</strong></span>
                      <span>{t('คุณภาพการสอน:', 'Teaching:')} <strong className="text-sky-700">{voiceResponse.ratings.teachingQuality}/5</strong></span>
                      <span>{t('การดูแลของอาจารย์:', 'Advisor:')} <strong className="text-sky-700">{voiceResponse.ratings.advisorSupport}/5</strong></span>
                      <span>{t('ภาพรวม:', 'Overall:')} <strong className="text-sky-700">{voiceResponse.ratings.overallExperience}/5</strong></span>
                    </div>
