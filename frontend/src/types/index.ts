...
export const ADVISING_CATEGORIES: { value: AdvisingCategory; label: string; labelEn: string; labelTh: string }[] = [
  { value: 'scholarship_document', label: 'Scholarship / Document Signing', labelEn: 'Scholarship / Document Signing', labelTh: 'ทุนการศึกษาและการลงนามเอกสาร' },
  { value: 'financial', label: 'Financial Issues', labelEn: 'Financial Issues', labelTh: 'ประเด็นด้านการเงินและค่าธรรมเนียมการศึกษา' },
  { value: 'registration', label: 'Course Registration', labelEn: 'Course Registration', labelTh: 'การลงทะเบียนเรียนและการเพิ่ม-ถอนรายวิชา' },
  { value: 'student_status', label: 'Student Status', labelEn: 'Student Status', labelTh: 'สถานภาพนักศึกษา' },
  { value: 'academic_performance', label: 'Academic Performance / GPA / Probation', labelEn: 'Academic Performance / GPA / Probation', labelTh: 'ผลการเรียน GPA และสถานะวิทยาทัณฑ์' },
  { value: 'internship_career', label: 'Internship / Co-op / Career', labelEn: 'Internship / Co-op / Career', labelTh: 'การฝึกงาน สหกิจศึกษา และการวางแผนอาชีพ' },
  { value: 'personal', label: 'Personal Issues', labelEn: 'Personal Issues', labelTh: 'ประเด็นส่วนบุคคลและการปรับตัว' },
  { value: 'withdrawal_leave', label: 'Withdrawal / Leave of Absence / Transfer', labelEn: 'Withdrawal / Leave of Absence / Transfer', labelTh: 'การขอลาพักการศึกษา ลาออก หรือโอนย้าย' },
]
...
export const EXIT_REASON_CODES: { value: ExitReasonCode; label: string; labelEn: string; labelTh: string }[] = [
  { value: 'financial', label: 'Financial Difficulty', labelEn: 'Financial Difficulty', labelTh: 'ข้อจำกัดด้านการเงินและค่าใช้จ่าย' },
  { value: 'academic', label: 'Academic Difficulty', labelEn: 'Academic Difficulty', labelTh: 'ผลการเรียนและความเหมาะสมกับสาขาวิชา' },
  { value: 'health', label: 'Physical Health', labelEn: 'Physical Health', labelTh: 'ปัญหาสุขภาพทางกาย' },
  { value: 'personal_family', label: 'Personal / Family Circumstances', labelEn: 'Personal / Family Circumstances', labelTh: 'ภาระด้านครอบครัวหรือเหตุผลส่วนบุคคล' },
  { value: 'mental_health', label: 'Mental Health', labelEn: 'Mental Health', labelTh: 'ภาวะสุขภาพจิตและความเครียด' },
  { value: 'transfer', label: 'Institution Transfer', labelEn: 'Institution Transfer', labelTh: 'โอนย้ายสถาบันการศึกษา' },
  { value: 'career_work', label: 'Career / Employment', labelEn: 'Career / Employment', labelTh: 'การประกอบอาชีพหรือการศึกษาต่อ' },
  { value: 'other', label: 'Other Reasons', labelEn: 'Other Reasons', labelTh: 'เหตุผลอื่น ๆ' },
]
...
export const EARLY_WARNING_TYPES: { value: EarlyWarningType; label: string; labelEn: string; labelTh: string }[] = [
  { value: 'academic_risk', label: 'Academic Risk (Low GPA)', labelEn: 'Academic Risk (Low GPA)', labelTh: 'ความเสี่ยงทางวิชาการ (GPA ต่ำ)' },
  { value: 'financial_risk', label: 'Financial Risk', labelEn: 'Financial Risk', labelTh: 'ความเสี่ยงจากการค้างชำระค่าธรรมเนียม' },
  { value: 'attendance', label: 'Attendance Risk', labelEn: 'Attendance Risk', labelTh: 'ความเสี่ยงจากการเข้าเรียนไม่สม่ำเสมอ' },
  { value: 'personal', label: 'Personal & Well-being', labelEn: 'Personal & Well-being', labelTh: 'ประเด็นส่วนบุคคลและความเป็นอยู่' },
]
